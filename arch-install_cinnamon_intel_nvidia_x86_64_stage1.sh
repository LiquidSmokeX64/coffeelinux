...
arch-chroot /mnt echo '[testing]' >> /etc/pacman.conf && 
arch-chroot /mnt echo 'Include = /etc/pacman.d/mirrorlist' >> /etc/pacman.conf &&
arch-chroot /mnt echo '[multilib-testing]' >> /etc/pacman.conf && 
arch-chroot /mnt echo 'Include = /etc/pacman.d/mirrorlist' >> /etc/pacman.conf &&
arch-chroot /mnt pacman -Syy && 
...
arch-chroot /mnt pacman -Sy sudo nano gtk4 cinnamon lightdm gnome-terminal gedit gnome-system-monitor gnome-keyring cinnamon-translations &&
