...
echo "Set your username (no caps please)."
read user00
user01=$user00

echo "Set your drive ('/dev/nvmeXn1 or sdX')"
read drive
drive0=$drive

echo "Set your boot partition ('/dev/nvmeXn1p1 or sdX1')."
read boot
boot0=$boot

echo "Set your swap partition ('/dev/nvmeXn1p2 or sdX2')."
read swap
swap0=$swap

echo "Set your system/home partition ('/dev/nvmeXn1p3 or sdX3')."
read system
system0=$system
...
mkswap $swap0 && 
mkfs.btrfs -L LocalDisk $system0 && 
echo 'Mounting Disks' && 
read -n 1 -s -r -p "Press any key to continue"
swapon $swap0 && 
mount $system0 /mnt && 
